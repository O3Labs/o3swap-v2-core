...
import "./libs/CeloUbeswapLibrary.sol";
...
contract O3CeloUbeswapAggregator is Ownable {
    ...
    function _swapExactTokensForTokensSupportingFeeOnTransferTokens(
        ...
        if (pull) {
            ...
            IERC20(path[0]).safeTransfer(CeloUbeswapLibrary.pairFor(factory, path[0], path[1]), amountIn);
        }
