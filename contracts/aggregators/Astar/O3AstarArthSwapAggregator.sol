...
contract O3AstarArthSwapAggregator is Ownable {
    ...
    address public router = 0xE915D2393a08a00c5A463053edD31bAe2199b9e7;
    ...
    function _swapExactETHForTokensSupportingFeeOnTransferTokens(
        ...
        uint balanceBefore = IERC20(path[path.length-1]).balanceOf(address(this));
        IPancakeRouter02(router).swapExactETHForTokensSupportingFeeOnTransferTokens{value: msg.value - fee}(
